...
class WishlistUpdateItemInWishlistRequestPayload(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["preferredQuantity", "description", "customerGrn"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WishlistUpdateItemInWishlistRequestPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WishlistUpdateItemInWishlistRequestPayload from a dict"""
        if obj is None:
            return None
