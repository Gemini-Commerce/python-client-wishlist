...
class WishlistSharingRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["wishlistId", "permission", "customerGrn", "customerAggregationId"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WishlistSharingRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WishlistSharingRequest from a dict"""
        if obj is None:
            return None
